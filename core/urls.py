...
urlpatterns = [ 
    ...
    #re_path('^v/(?P<maindatasetuid>[0-9]+.?[0-9]*)/$', core_views.visualization_fg, name='regular_visualization_f'),
    ...
    #re_path('^v/(?P<maindatasetuid>[0-9]+.?[0-9]*)(?P<groups>(/g/[0-9]+)*)/$', core_views.visualization_fg, name='regular_visualization_fg'),
    #re_path('^v/(?P<maindatasetuid>[0-9]+.?[0-9]*)(?P<groups>(/g/[0-9]+)*)/g/NEWGROUPID/$', core_views.visualization_fg, name='regular_visualization_fg_newgroup'),
    #re_path('^v/(?P<maindatasetuid>[0-9]+.?[0-9]*)/(?P<groups>(g/[0-9]+/)*)g/NEWGROUPID/(o/(?P<operationnumber>[0-9]+))?/$', core_views.visualization_data, name='regular_visualization_fgo_newgroup'),
